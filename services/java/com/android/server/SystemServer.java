...
public final class SystemServer {
        ...
        public void onChange(boolean selfChange) {
            try {
                int adbPort = Settings.Global.getInt(mContentResolver,
                        Settings.Global.ADB_WIRELESS, 0);
    ...
    private void startAquaAdditions() {
        Settings.Global.putInt(mContentResolver, Settings.Global.ADB_WIRELESS,
                Integer.parseInt(SystemProperties.get("service.adb.tcp.port", "0")));

        // register observer to listen for settings changes
        mContentResolver.registerContentObserver(
                Settings.Global.getUriFor(Settings.Global.ADB_WIRELESS),
