...
public class NavigationModeController implements Dumpable {
    ...
    private final class AquaSettingsObserver extends ContentObserver {
        public AquaSettingsObserver(Handler handler) {
            super(handler);
        }
    ...
    private AquaSettingsObserver mSettingsObserver;
    ...
    public NavigationModeController(Context context,
        ...
        mSettingsObserver = new AquaSettingsObserver(new Handler());
